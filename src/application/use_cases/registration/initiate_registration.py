import secrets
from application.dtos import AuthResponseDTO, AuthCredentialsDTO
...
class InitiateRegistrationUseCase:
    ...
    async def execute(self, input_dto: AuthCredentialsDTO) -> AuthResponseDTO:
        ...
        password_hash = HashedPassword(self.password_hasher.hash(input_dto.password))
        ...
        otp = secrets.randbelow(899000) + 100000
